...
from clearledger.api import router as ledger_router
...
def create_app(public=None):
    ...
    application = FastAPI(title="ClearLedger", version="0.2.0", description="Synthetic financial sandboxes. No real funds or live trading.")
    if public:
